...
(
    ...
    `base_on_base_vehicle_id` varchar(32)     NOT NULL DEFAULT '' COMMENT 'Based On Base Vehicle ID',
    `base_on_pc_id`           varchar(64)     NOT NULL DEFAULT '' COMMENT 'Based On PC ID',
    `brand`                   varchar(32)     NOT NULL DEFAULT '' COMMENT 'Model的品牌',
    `skip_check`              varchar(32)     NOT NULL DEFAULT '' COMMENT 'Skip Check开关，取值Open、Close',
