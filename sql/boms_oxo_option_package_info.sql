CREATE TABLE `boms_oxo_option_package_info` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `row_id` bigint NOT NULL COMMENT 'oxo行id',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_key` (`row_id`,`base_vehicle_id`) USING BTREE,
  KEY `idx_row_id` (`row_id`) USING BTREE,
