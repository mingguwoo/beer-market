...
(
    ...
    `pc_id`           varchar(64)     NOT NULL DEFAULT '' COMMENT 'PC id',
    `option_code`     varchar(64)     NOT NULL DEFAULT '' COMMENT 'Option Code',
    `select_status`   varchar(32)     NOT NULL DEFAULT '' COMMENT '勾选状态，取值Select、Unselect',
    `select_can_edit` varchar(32)     NOT NULL DEFAULT '' COMMENT '勾选是否可编辑，取值Yes、No',
